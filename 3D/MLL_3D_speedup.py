...
# to numbda lists.                                      #
# NOTE: Parallelize input? Could work!                  #
# # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
def main():
    ...
    normalizationAngles = [ List(list(map(float,i.split()))) for i in open(normalizationData_filename).readlines() ]    # list (of numba lists) 
    ...
    print(f"--- {(time.time() - t2):.3f} seconds total for all input data ---")
    ########## END READ DATA ##########
